$(function(){
	...
	$("a.m01").mouseover(function(){
		$("a.m01").find("img").attr("src","images/i_01_over.jpg");
	});
	$("a.m01").mouseout(function(){
		$("a.m01").find("img").attr("src","images/i_01.jpg");
	});
	$("a.m02").mouseover(function(){
		$("a.m02").find("img").attr("src","images/i_02_over.jpg");
	});
	$("a.m02").mouseout(function(){
		$("a.m02").find("img").attr("src","images/i_02.jpg");
	});
	$("a.m03").mouseover(function(){
		$("a.m03").find("img").attr("src","images/i_03_over.jpg");
	});
	$("a.m03").mouseout(function(){
		$("a.m03").find("img").attr("src","images/i_03.jpg");
	});
	$("a.m04").mouseover(function(){
		$("a.m04").find("img").attr("src","images/i_04_over.jpg");
	});
	$("a.m04").mouseout(function(){
		$("a.m04").find("img").attr("src","images/i_04.jpg");
	});
